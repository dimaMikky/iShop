                ...
                <div class="cart box_1">
                    <a href="cart/show" onclick="getCart(); return false;">
                        <div class="total">
                            ...
                            <span class="simpleCart_total"><?=$_SESSION['cart.currency']['symbol_left'] . $_SESSION['cart.sum'] . $_SESSION['cart.currency']['symbol_right'] . ' ('.$_SESSION['cart.qty'].')';?></span>
                            <?php else: ?>
                            <span class="simpleCart_total">Пустая корзина</span>
                            <?php endif; ?>
                        </div>
                    </a>
                   <div class="clearfix"> </div>
